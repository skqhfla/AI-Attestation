...
parser.add_argument("--challenge_batch_size", type=int, default=128)
...
def get_dataloader(dataset_name, data_path, workers, batch_size):
...
def main():
    ...
    train_loader, test_loader, num_classes = get_dataloader(
            args.dataset, args.data_path, args.workers, args.test_batch_size)
...
def perform_attack(attacker, model, model_clean, train_loader, test_loader,
    ...
    challenge_dir_random = './data/challenge/' + args.arch + "/random"
    ...
    for i_iter in range(N_iter):
        ...
        try:
            ...
            print_log(f'max loss module : {attack_log[2]}', log)
        except:
            pass
        ...
        if challenge_random_images:
            ...
            for start_idx_random in range(0, challenge_random_data.size(0), args.challenge_batch_size):
